...
namespace SSD_Assignment___Banking_Application
{
    public class Encryption_Handler
    {
        ...
        public static Aes genKey(byte[] iv)
        ...
        public static string EncryptProperty(string propertyValue, Aes aes)
        {
        ...
        public static Bank_Account EncrypCurrentAccount(Bank_Account originalAccount)
        {
        ...
        public static Bank_Account DecrypCurrentAccount(Bank_Account originalAccount)
        {
            Aes aes = genKey(originalAccount.iv);
